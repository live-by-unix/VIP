...
In addition, this is a list of ALL keyboard shortcuts. ^W Write Mode  ^I Insert mode  ^Q Exit No Save  ^Y Save Insert  ^X Exit Write  ^T Exit Insert  ^G Exit Save All.        
